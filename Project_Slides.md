...
=============================================
A presentation on Capstone Project "Swiftkey predictor"

By Irving Veliz [Agu 18, 2020]
...
on the linear interpolation of trigrams, bigrams, and unigrams is developed. The web-based application can be found <a href="https://iveliz12.shinyapps.io/Swiftkey_predictor_IDVS/"> here</a> and the source files for this project can be found <a href="https://github.com/Iveliz12/Swiftkey_Predictor_IDVS"> here</a>. App user interface looks like this </small>
